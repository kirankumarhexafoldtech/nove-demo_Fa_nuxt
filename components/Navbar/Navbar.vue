<template>
    ...
    :class="`${
        !isNavFixed
          ? 'navbar navbar-main navbar-expand-lg px-1 mx-3 border-radius-xl shadow-none'
          : `navbar navbar-main navbar-expand-lg px-1 mx-4 border-radius-xl shadow-none position-sticky ${
